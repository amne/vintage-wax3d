// OGL3.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(COGL3App, CWinApp)
	//{{AFX_MSG_MAP(COGL3App)
...
COGL3App::COGL3App()
{
	...
	m_dTimeElapsed = 0.0;	 
	m_dTimeScale = 0.0;		
	m_lFramesPerSecond = 200;

}

/////////////////////////////////////////////////////////////////////////////
// The one and only COGL3App object

COGL3App theApp;

/////////////////////////////////////////////////////////////////////////////
// COGL3App initialization

BOOL COGL3App::InitInstance()
{
